...
$thumb_prefix			= "goodsImg_"; //Normal thumb Prefix
$destination_folder		= './Uploads/goodsImg/'; //upload directory ends with / (slash)
...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if($image_res){
		...
		// {
			...
			echo "<input  type='hidden' name='headerImg' value=".$thumb_prefix . $new_file_name.">";
		// }
